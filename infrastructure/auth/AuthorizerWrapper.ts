...
export class AuthorizerWrapper {
    ...
    private createUserPool(){
        this.userPool = new UserPool(this.scope, 'RecipeUserPool', {
    ...
    private addUserPoolClient(){
        this.userPoolClient = this.userPool.addClient('RecipeUserPool-client', {
          userPoolClientName: 'RecipeUserPool-client',
          authFlows: {
    ...
    private createAuthorizer(){
        this.authorizer = new CognitoUserPoolsAuthorizer(this.scope, 'RecipeUserAuthorizer', {
            cognitoUserPools:  [this.userPool],
            authorizerName: 'RecipeUserAuthorizer',
            identitySource: 'method.request.header.Authorization'
        });
        //TODO: See if method has been added to CognitoUserPoolsAuthorizer
